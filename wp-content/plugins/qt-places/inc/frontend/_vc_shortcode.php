  			...
  			array(
				...
				"params" => 
					array(
						...
						array(
						   "type" => "colorpicker",
						   "heading" => esc_html__( "Buttons text color", "proradio" ),
						  'group' => esc_html__( 'Colors', 'qt-places' ),
						   "param_name" => "buttoncolor"
						),
						array(
						   "type" => "colorpicker",
						   "heading" => esc_html__( "Buttons background color", "proradio" ),
						  'group' => esc_html__( 'Colors', 'qt-places' ),
						   "param_name" => "buttonbackground"
						),
						array(
						   "type" => "colorpicker",
						   "heading" => esc_html__( "List background color", "proradio" ),
						  'group' => esc_html__( 'Colors', 'qt-places' ),
						   "param_name" => "listbackground"
						),
						array(
						   "type" => "colorpicker",
						   "heading" => esc_html__( "Marker text color", "proradio" ),
						  'group' => esc_html__( 'Colors', 'qt-places' ),
