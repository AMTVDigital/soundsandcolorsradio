...
class Plugin {
	...
	private function include_widgets_files() {
		...
		require_once( __DIR__ . '/widgets/customplayer/customplayer.php' );
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\ProradioElementorRadioCard() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\ProradioElementorCustomPlayer() );
