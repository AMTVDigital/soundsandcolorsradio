			...
			*	Used by themeScroll
			...
			qt3dHeader: {
				...
				setStartingPoint: function(){
					...
					$('.proradio-3dheader').each(function(i,c){
						var item = [], 
							el = $(c);
						item['el'] = el;
						item['content'] = el.find('.proradio-3dheader__contents');
						item['bg1'] = el.find('.proradio-3dheader__bg--1');
						item['bg2'] = el.find('.proradio-3dheader__bg--2');
			...
			popupLink: function(){
				...
				$("body").on("click", ".proradio-popupwindow, .qt-popupwindow", function(e){
					e.preventDefault();
			...
			countFps: function(){
				$("body").append('<output id="proradioPerformanceCheck" class="proradio-fps" style="position: fixed;top: 0;left: 0;background:red;color:white;z-index:9999999;opacity: 0;"></output>');
				...
				var $out = $('#proradioPerformanceCheck');
				(function loop() {
