...
<span><?php echo proradio_do_shortcode('[proradio_reaktions-sharebox-fp class="" label="'.esc_attr('Share', 'proradio').'" btnclass="proradio-btn proradio-btn__r" id="'.get_the_id().'" url="'.esc_attr( get_the_permalink() ).'" ]' ); ?></span>