...
== Copyright ==
Pro.Radio WordPress Theme, Copyright 2020 Pro.Radio Qantum Themes S.L.

== Changelog ==
https://pro.radio/changelog/


[ ] G.maps single event https://pro.radio/shop/mypradmin/supporttickets.php?action=view&id=861
[ ] Items opacity overlay control https://pro.radio/shop/mypradmin/supporttickets.php?action=view&id=872


@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

1.6.0 [2021-02-08] OPEN
IMPORTANT: THIS IS A MAJOR UPDATE
Please make sure to backup your website first, and update every required plugin.

Major changes: 

1. MEDIA FILES IN CUSTOM TYPES ARE NOW STORED BY ID
Podcast and chart mp3 files will be (from now on) stored as ID and not as file URL. This allows easier site migration.
Retro compatibility will ensure all of your existing charts and podcasts will still work fine.
To make sure both new and old podcasts and charts work fine, please update any plugin.

2. CORE FUNCTIONS FOR CUSTOM TYPES HAVE BEEN UPDATED
In some files the name of the custom type functions has been updated and the custom fields have been moved inside of the custom type function. This ensures higher compatibility, is more correct and allows chil dtheme override.
If you did changes to the source code or created cusotm variants of the functions, please find the details of "MODIFIED" below.

3. ADDED CUSTOM HEADER IMAGE
Now you can set a custom background for the header of your contents, different from the featured image.


@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

[x] Updated Theme Core plugin - FILES are now linked by ID in database for easier site migration
[x] Updated ProRadio Player plugin
[x] Updated several tempaltes for podcasts
[x] ADDED Custom header image all post types
[x] ADDED Clear Cache panel in ProRadio Admin
[x] ADDED Knowledgebase search and index in Admin
[x] MODIFIED core file podcast-type.php - custom fields moved into proradio_podcast_register_type. Init action moved in function_exists statement.
[x] MODIFIED core file radio-type.pgp - custom fields moved into proradio_radiochannel_register_type
[x] MODIFIED shows-type.pho - custom fields moved into proradio_shows_register_type
[x] MODIFIED function in inc/theme-base-functions/slugify.php 'ASCII//IGNORE' instead of 'ASCII//TRANSLIT'



1.5.9.2 [2021-02-05]
[x] Player updated: azuracast extended compatibility
[x] ReAktions plugin update: fixed PHP notice if thumbnail is missing
[x] Several code fixes for php performance. Fixed some PHP notice for undefined variables
[x] ADDED Single show option to hide current show timetable (Display timetable in single show page)
[x] ProRadio Swipebox PR.5.8 [2021 02 05] * Avoid opening playlists and channels links of youtube in lightbox


1.5.9.1 [2021-01-27]
[x] FIX related members - single-members.php line 69
